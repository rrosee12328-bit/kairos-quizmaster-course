...
export default function Landing() {
    ...
    <main id="main">
      <section className="ks-hero" aria-labelledby="hero-title">
        ...
        <div className="ks-hero-copy"><p className="ks-eyebrow"><span /> PROFESSIONAL SECURITY TRAINING</p><h1 id="hero-title">Train for your<br /><span>Texas security license.</span></h1><p className="ks-hero-description">Become a security officer in Texas. Level 2, Level 3, and Level 4 training for Texas security licensing only.</p><div className="ks-hero-actions"><a className="ks-button" href="#training">Find your path <ArrowDown size={18}/></a><button className="ks-film-link" onClick={() => setVideoOpen(true)}><span><Play size={13} fill="currentColor"/></span> Meet the academy</button></div></div>
