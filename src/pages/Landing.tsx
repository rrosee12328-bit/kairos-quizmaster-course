...
export default function Landing() {
    ...
    <main id="main">
      <section className="ks-hero" aria-labelledby="hero-title">
        ...
        <div className="ks-hero-copy"><p className="ks-eyebrow"><span /> PROFESSIONAL SECURITY TRAINING</p><h1 id="hero-title">Train for your<br /><span>security license.</span></h1><p className="ks-hero-description">Start your path to becoming a licensed security officer with Level 2, Level 3, and Level 4 training.</p><div className="ks-hero-actions"><a className="ks-button" href="#training">Find your path <ArrowDown size={18}/></a><button className="ks-film-link" onClick={() => setVideoOpen(true)}><span><Play size={13} fill="currentColor"/></span> Meet the academy</button></div></div>
